...
It is not obvious that the data flags here are causing a major change in how we
...
There is clearly pattern there, but the Viridis color scale is really more 
...
On the other hand, there is a strong N to p ratio pattern.  Since there is only
a little seasonal pattern in the N values, the P values must climb seasonally.
